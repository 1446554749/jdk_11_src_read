...
/**
 * Support for the {@link ProcessingCapacityNotificationInfo} class.
 */
public final class ProcessingCapacityNotificationInfoUtil {

	private static CompositeType compositeType;

	/**
	 * @return an instance of {@link CompositeType} for the {@link ProcessingCapacityNotificationInfo} class
	 */
	private static CompositeType getCompositeType() {
		if (compositeType == null) {
			String[] names = { "newProcessingCapacity" }; //$NON-NLS-1$
			String[] descs = { "newProcessingCapacity" }; //$NON-NLS-1$
	 ...
	 */
	public static CompositeData toCompositeData(ProcessingCapacityNotificationInfo info) {
	...
	private ProcessingCapacityNotificationInfoUtil() {
		super();
	}
