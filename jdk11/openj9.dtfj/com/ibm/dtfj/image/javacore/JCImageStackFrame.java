...
public class JCImageStackFrame implements ImageStackFrame {
	...
	public ImagePointer getProcedureAddress() throws CorruptDataException {
		if (proc == null) throw new CorruptDataException(new JCCorruptData("no procedure address", null));
		return proc;
	}

	public String getProcedureName() throws CorruptDataException {
		if (name == null) throw new CorruptDataException(new JCCorruptData("no procedure name", null));
		return name;
	}
}
