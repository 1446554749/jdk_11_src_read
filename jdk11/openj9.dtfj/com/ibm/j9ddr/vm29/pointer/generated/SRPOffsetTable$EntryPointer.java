...
/**
 * Structure: SRPOffsetTable$EntryPointer
 *
 ...
 *
 * The generated code will provide getters for all elements in the SRPOffsetTable$EntryPointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=SRPOffsetTable$Entry.class)
...
/*[END USER CODE]*/
	...
	protected SRPOffsetTable$EntryPointer(long address) {
		super(address);
	}

	public static SRPOffsetTable$EntryPointer cast(AbstractPointer structure) {
	...
	public static SRPOffsetTable$EntryPointer cast(long address) {
		if (address == 0) {
			return NULL;
		}
		return new SRPOffsetTable$EntryPointer(address);
	}

	public SRPOffsetTable$EntryPointer add(long count) {
		return SRPOffsetTable$EntryPointer.cast(address + (SRPOffsetTable$Entry.SIZEOF * count));
	}

	public SRPOffsetTable$EntryPointer add(Scalar count) {
		return add(count.longValue());
	}

	public SRPOffsetTable$EntryPointer addOffset(long offset) {
		return SRPOffsetTable$EntryPointer.cast(address + offset);
	}

	public SRPOffsetTable$EntryPointer addOffset(Scalar offset) {
		return addOffset(offset.longValue());
	}

	public SRPOffsetTable$EntryPointer sub(long count) {
		return SRPOffsetTable$EntryPointer.cast(address - (SRPOffsetTable$Entry.SIZEOF * count));
	}

	public SRPOffsetTable$EntryPointer sub(Scalar count) {
		return sub(count.longValue());
	}

	public SRPOffsetTable$EntryPointer subOffset(long offset) {
		return SRPOffsetTable$EntryPointer.cast(address - offset);
	}

	public SRPOffsetTable$EntryPointer subOffset(Scalar offset) {
		return subOffset(offset.longValue());
	}

	public SRPOffsetTable$EntryPointer untag(long mask) {
		return SRPOffsetTable$EntryPointer.cast(address & ~mask);
	}
