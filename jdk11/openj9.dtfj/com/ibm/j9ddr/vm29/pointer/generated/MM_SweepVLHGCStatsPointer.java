...
/**
 * Structure: MM_SweepVLHGCStatsPointer
 *
 ...
 *
 * The generated code will provide getters for all elements in the MM_SweepVLHGCStatsPointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=MM_SweepVLHGCStats.class)
...
/*[END USER CODE]*/
	...
	protected MM_SweepVLHGCStatsPointer(long address) {
		super(address);
	}

	public static MM_SweepVLHGCStatsPointer cast(AbstractPointer structure) {
	...
	public static MM_SweepVLHGCStatsPointer cast(long address) {
		if (address == 0) {
			return NULL;
		}
		return new MM_SweepVLHGCStatsPointer(address);
	}

	public MM_SweepVLHGCStatsPointer add(long count) {
		return MM_SweepVLHGCStatsPointer.cast(address + (MM_SweepVLHGCStats.SIZEOF * count));
	}

	public MM_SweepVLHGCStatsPointer add(Scalar count) {
		return add(count.longValue());
	}

	public MM_SweepVLHGCStatsPointer addOffset(long offset) {
		return MM_SweepVLHGCStatsPointer.cast(address + offset);
	}

	public MM_SweepVLHGCStatsPointer addOffset(Scalar offset) {
		return addOffset(offset.longValue());
	}

	public MM_SweepVLHGCStatsPointer sub(long count) {
		return MM_SweepVLHGCStatsPointer.cast(address - (MM_SweepVLHGCStats.SIZEOF * count));
	}

	public MM_SweepVLHGCStatsPointer sub(Scalar count) {
		return sub(count.longValue());
	}

	public MM_SweepVLHGCStatsPointer subOffset(long offset) {
		return MM_SweepVLHGCStatsPointer.cast(address - offset);
	}

	public MM_SweepVLHGCStatsPointer subOffset(Scalar offset) {
		return subOffset(offset.longValue());
	}

	public MM_SweepVLHGCStatsPointer untag(long mask) {
		return MM_SweepVLHGCStatsPointer.cast(address & ~mask);
	}
	...
	public UDATAPointer _endTimeEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_SweepVLHGCStats.__endTimeOffset_));
	}
	...
	public UDATA _gcCount() throws CorruptDataException {
		return new U64(getLongAtOffset(MM_SweepVLHGCStats.__gcCountOffset_));
	}

	// U64 _gcCount
	public UDATAPointer _gcCountEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_SweepVLHGCStats.__gcCountOffset_));
	}
	...
	public UDATAPointer _startTimeEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_SweepVLHGCStats.__startTimeOffset_));
	}
	...
	public UDATAPointer idleTimeEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_SweepVLHGCStats._idleTimeOffset_));
	}
	...
	public UDATAPointer mergeTimeEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_SweepVLHGCStats._mergeTimeOffset_));
	}
	...
	public UDATA sweepChunksProcessed() throws CorruptDataException {
		return new U64(getLongAtOffset(MM_SweepVLHGCStats._sweepChunksProcessedOffset_));
	}
	...
	public UDATA sweepChunksTotal() throws CorruptDataException {
		return new U64(getLongAtOffset(MM_SweepVLHGCStats._sweepChunksTotalOffset_));
	}
