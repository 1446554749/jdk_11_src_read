...
/*[END USER CODE]*/
	...
	public PointerPointer _countEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(MM_YieldCollaborator.__countOffset_));
	}
	...
	public PointerPointer _mutexEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(MM_YieldCollaborator.__mutexOffset_));
	}
	...
	public MM_YieldCollaboratorPointer _prev() throws CorruptDataException {
		return MM_YieldCollaboratorPointer.cast(getPointerAtOffset(MM_YieldCollaborator.__prevOffset_));
	}

	// MM_YieldCollaborator* _prev
	public PointerPointer _prevEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(MM_YieldCollaborator.__prevOffset_));
	}
	...
	public EnumPointer _resumeEventEA() throws CorruptDataException {
		return EnumPointer.cast(nonNullFieldEA(MM_YieldCollaborator.__resumeEventOffset_), MM_YieldCollaborator$ResumeEvent.class);
	}
	...
	public UDATAPointer _yieldCountEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_YieldCollaborator.__yieldCountOffset_));
	}
	...
	public UDATAPointer _yieldIndexEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_YieldCollaborator.__yieldIndexOffset_));
	}
