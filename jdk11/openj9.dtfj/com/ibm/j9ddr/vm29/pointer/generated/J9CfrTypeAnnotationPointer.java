...
/*[END USER CODE]*/
	...
	public J9CfrAnnotationPointer annotation() throws CorruptDataException {
		return J9CfrAnnotationPointer.cast(nonNullFieldEA(J9CfrTypeAnnotation._annotationOffset_));
	}

	// J9CfrAnnotation annotation
	public PointerPointer annotationEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9CfrTypeAnnotation._annotationOffset_));
	}
	...
	public J9CfrTypeAnnotationTargetInfoPointer targetInfo() throws CorruptDataException {
		return J9CfrTypeAnnotationTargetInfoPointer.cast(nonNullFieldEA(J9CfrTypeAnnotation._targetInfoOffset_));
	}

	// J9CfrTypeAnnotationTargetInfo targetInfo
	public PointerPointer targetInfoEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9CfrTypeAnnotation._targetInfoOffset_));
	}
	...
	public U8Pointer targetTypeEA() throws CorruptDataException {
		return U8Pointer.cast(nonNullFieldEA(J9CfrTypeAnnotation._targetTypeOffset_));
	}
	...
	public J9CfrTypePathPointer typePath() throws CorruptDataException {
		return J9CfrTypePathPointer.cast(nonNullFieldEA(J9CfrTypeAnnotation._typePathOffset_));
	}

	// J9CfrTypePath typePath
	public PointerPointer typePathEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9CfrTypeAnnotation._typePathOffset_));
	}
