...
/*[END USER CODE]*/
	...
	public PointerPointer _bufferEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(BufferManager.__bufferOffset_));
	}
	...
	public UDATA _bufferSize() throws CorruptDataException {
		return getUDATAAtOffset(BufferManager.__bufferSizeOffset_);
	}

	// UDATA _bufferSize
	public UDATAPointer _bufferSizeEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(BufferManager.__bufferSizeOffset_));
	}
	...
	public PointerPointer _lastAllocationEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(BufferManager.__lastAllocationOffset_));
	}
	...
	public PointerPointer _portLibraryEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(BufferManager.__portLibraryOffset_));
	}
	...
	public UDATA _pos() throws CorruptDataException {
		return getUDATAAtOffset(BufferManager.__posOffset_);
	}

	// UDATA _pos
	public UDATAPointer _posEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(BufferManager.__posOffset_));
	}
	...
	public BoolPointer _shouldFreeBufferEA() throws CorruptDataException {
		return BoolPointer.cast(nonNullFieldEA(BufferManager.__shouldFreeBufferOffset_));
	}
