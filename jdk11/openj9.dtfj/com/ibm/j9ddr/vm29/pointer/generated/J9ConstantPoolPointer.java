...
/**
 * Structure: J9ConstantPoolPointer
 *
 ...
 *
 * The generated code will provide getters for all elements in the J9ConstantPoolPointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=J9ConstantPool.class)
public class J9ConstantPoolPointer extends StructurePointer {

	// NULL
	public static final J9ConstantPoolPointer NULL = new J9ConstantPoolPointer(0);
...
/*[END USER CODE]*/
	...
	public J9ConstantPoolPointer add(long count) {
		return J9ConstantPoolPointer.cast(address + (J9ConstantPool.SIZEOF * count));
	}
	...
	public J9ConstantPoolPointer addOffset(long offset) {
		return J9ConstantPoolPointer.cast(address + offset);
	}
	...
	public J9ConstantPoolPointer untag(long mask) {
		return J9ConstantPoolPointer.cast(address & ~mask);
	}
	...
	public J9ClassPointer ramClass() throws CorruptDataException {
		return J9ClassPointer.cast(getPointerAtOffset(J9ConstantPool._ramClassOffset_));
	}

	// J9Class* ramClass
	public PointerPointer ramClassEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9ConstantPool._ramClassOffset_));
	}
	...
	public J9ROMConstantPoolItemPointer romConstantPool() throws CorruptDataException {
		return J9ROMConstantPoolItemPointer.cast(getPointerAtOffset(J9ConstantPool._romConstantPoolOffset_));
	}

	// J9ROMConstantPoolItem* romConstantPool
	public PointerPointer romConstantPoolEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9ConstantPool._romConstantPoolOffset_));
	}
