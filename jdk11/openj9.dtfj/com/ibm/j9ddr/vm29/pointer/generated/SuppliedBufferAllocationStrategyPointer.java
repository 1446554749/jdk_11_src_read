...
/**
 * Structure: SuppliedBufferAllocationStrategyPointer
 *
 ...
 *
 * The generated code will provide getters for all elements in the SuppliedBufferAllocationStrategyPointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=SuppliedBufferAllocationStrategy.class)
...
/*[END USER CODE]*/
	...
	protected SuppliedBufferAllocationStrategyPointer(long address) {
		super(address);
	}

	public static SuppliedBufferAllocationStrategyPointer cast(AbstractPointer structure) {
	...
	public static SuppliedBufferAllocationStrategyPointer cast(long address) {
		if (address == 0) {
			return NULL;
		}
		return new SuppliedBufferAllocationStrategyPointer(address);
	}

	public SuppliedBufferAllocationStrategyPointer add(long count) {
		return SuppliedBufferAllocationStrategyPointer.cast(address + (SuppliedBufferAllocationStrategy.SIZEOF * count));
	}

	public SuppliedBufferAllocationStrategyPointer add(Scalar count) {
		return add(count.longValue());
	}

	public SuppliedBufferAllocationStrategyPointer addOffset(long offset) {
		return SuppliedBufferAllocationStrategyPointer.cast(address + offset);
	}

	public SuppliedBufferAllocationStrategyPointer addOffset(Scalar offset) {
		return addOffset(offset.longValue());
	}

	public SuppliedBufferAllocationStrategyPointer sub(long count) {
		return SuppliedBufferAllocationStrategyPointer.cast(address - (SuppliedBufferAllocationStrategy.SIZEOF * count));
	}

	public SuppliedBufferAllocationStrategyPointer sub(Scalar count) {
		return sub(count.longValue());
	}

	public SuppliedBufferAllocationStrategyPointer subOffset(long offset) {
		return SuppliedBufferAllocationStrategyPointer.cast(address - offset);
	}

	public SuppliedBufferAllocationStrategyPointer subOffset(Scalar offset) {
		return subOffset(offset.longValue());
	}

	public SuppliedBufferAllocationStrategyPointer untag(long mask) {
		return SuppliedBufferAllocationStrategyPointer.cast(address & ~mask);
	}
	...
	// U8* _lineNumberBuffer
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="__lineNumberBufferOffset_", declaredType="U8*")
	...
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="__lineNumberBufferSizeOffset_", declaredType="UDATA")
	...
	// U8* _variableInfoBuffer
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="__variableInfoBufferOffset_", declaredType="U8*")
	...
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="__variableInfoBufferSizeOffset_", declaredType="UDATA")
