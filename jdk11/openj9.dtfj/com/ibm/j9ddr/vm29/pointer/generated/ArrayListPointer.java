 ...
 *
 * The generated code will provide getters for all elements in the ArrayListPointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=ArrayList.class)
public class ArrayListPointer extends StructurePointer {
...
/*[END USER CODE]*/
	...
	public ArrayListPointer add(long count) {
		return ArrayListPointer.cast(address + (ArrayList.SIZEOF * count));
	}
	...
	public ArrayListPointer addOffset(long offset) {
		return ArrayListPointer.cast(address + offset);
	}
	...
	public ArrayListPointer untag(long mask) {
		return ArrayListPointer.cast(address & ~mask);
	}
	...
	// void** header
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="_headerOffset_", declaredType="void**")
	public PointerPointer header() throws CorruptDataException {
		return PointerPointer.cast(getPointerAtOffset(ArrayList._headerOffset_));
	}

	// void** header
	public PointerPointer headerEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(ArrayList._headerOffset_));
	}

	// UDATA slabSize
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="_slabSizeOffset_", declaredType="UDATA")
	public UDATA slabSize() throws CorruptDataException {
		return getUDATAAtOffset(ArrayList._slabSizeOffset_);
	}

	// UDATA slabSize
	public UDATAPointer slabSizeEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(ArrayList._slabSizeOffset_));
	}
