...
/**
 * Structure: MM_OwnableSynchronizerObjectBufferPointer
 *
 ...
 *
 * The generated code will provide getters for all elements in the MM_OwnableSynchronizerObjectBufferPointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=MM_OwnableSynchronizerObjectBuffer.class)
...
/*[END USER CODE]*/
	...
	protected MM_OwnableSynchronizerObjectBufferPointer(long address) {
		super(address);
	}

	public static MM_OwnableSynchronizerObjectBufferPointer cast(AbstractPointer structure) {
	...
	public static MM_OwnableSynchronizerObjectBufferPointer cast(long address) {
		if (address == 0) {
			return NULL;
		}
		return new MM_OwnableSynchronizerObjectBufferPointer(address);
	}

	public MM_OwnableSynchronizerObjectBufferPointer add(long count) {
		return MM_OwnableSynchronizerObjectBufferPointer.cast(address + (MM_OwnableSynchronizerObjectBuffer.SIZEOF * count));
	}

	public MM_OwnableSynchronizerObjectBufferPointer add(Scalar count) {
		return add(count.longValue());
	}

	public MM_OwnableSynchronizerObjectBufferPointer addOffset(long offset) {
		return MM_OwnableSynchronizerObjectBufferPointer.cast(address + offset);
	}

	public MM_OwnableSynchronizerObjectBufferPointer addOffset(Scalar offset) {
		return addOffset(offset.longValue());
	}

	public MM_OwnableSynchronizerObjectBufferPointer sub(long count) {
		return MM_OwnableSynchronizerObjectBufferPointer.cast(address - (MM_OwnableSynchronizerObjectBuffer.SIZEOF * count));
	}

	public MM_OwnableSynchronizerObjectBufferPointer sub(Scalar count) {
		return sub(count.longValue());
	}

	public MM_OwnableSynchronizerObjectBufferPointer subOffset(long offset) {
		return MM_OwnableSynchronizerObjectBufferPointer.cast(address - offset);
	}

	public MM_OwnableSynchronizerObjectBufferPointer subOffset(Scalar offset) {
		return subOffset(offset.longValue());
	}

	public MM_OwnableSynchronizerObjectBufferPointer untag(long mask) {
		return MM_OwnableSynchronizerObjectBufferPointer.cast(address & ~mask);
	}
	...
	public PointerPointer _extensionsEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(MM_OwnableSynchronizerObjectBuffer.__extensionsOffset_));
	}
	...
	public PointerPointer _headEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(MM_OwnableSynchronizerObjectBuffer.__headOffset_));
	}
	...
	public UDATA _maxObjectCount() throws CorruptDataException {
		return getUDATAAtOffset(MM_OwnableSynchronizerObjectBuffer.__maxObjectCountOffset_);
	}

	// const UDATA _maxObjectCount
	public UDATAPointer _maxObjectCountEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_OwnableSynchronizerObjectBuffer.__maxObjectCountOffset_));
	}
	...
	public UDATA _objectCount() throws CorruptDataException {
		return getUDATAAtOffset(MM_OwnableSynchronizerObjectBuffer.__objectCountOffset_);
	}

	// UDATA _objectCount
	public UDATAPointer _objectCountEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_OwnableSynchronizerObjectBuffer.__objectCountOffset_));
	}
	...
	public PointerPointer _regionEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(MM_OwnableSynchronizerObjectBuffer.__regionOffset_));
	}
	...
	public PointerPointer _tailEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(MM_OwnableSynchronizerObjectBuffer.__tailOffset_));
	}
