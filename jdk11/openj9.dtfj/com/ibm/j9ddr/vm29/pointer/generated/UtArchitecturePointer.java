...
/**
 * Structure: UtArchitecturePointer
 *
 ...
 *
 * The generated code will provide getters for all elements in the UtArchitecturePointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=UtArchitecture.class)
public class UtArchitecturePointer extends StructurePointer {

	// NULL
	public static final UtArchitecturePointer NULL = new UtArchitecturePointer(0);
...
/*[END USER CODE]*/
	...
	public UtArchitecturePointer add(long count) {
		return UtArchitecturePointer.cast(address + (UtArchitecture.SIZEOF * count));
	}
	...
	public UtArchitecturePointer addOffset(long offset) {
		return UtArchitecturePointer.cast(address + offset);
	}
	...
	public UtArchitecturePointer untag(long mask) {
		return UtArchitecturePointer.cast(address & ~mask);
	}
