...
/*[END USER CODE]*/
	...
	public MM_CollectionStatisticsStandardPointer _collectionStatistics() throws CorruptDataException {
		return MM_CollectionStatisticsStandardPointer.cast(nonNullFieldEA(MM_SegregatedGC.__collectionStatisticsOffset_));
	}

	// MM_CollectionStatisticsStandard _collectionStatistics
	public PointerPointer _collectionStatisticsEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(MM_SegregatedGC.__collectionStatisticsOffset_));
	}
	...
	public MM_CycleStatePointer _cycleState() throws CorruptDataException {
		return MM_CycleStatePointer.cast(nonNullFieldEA(MM_SegregatedGC.__cycleStateOffset_));
	}

	// MM_CycleState _cycleState
	public PointerPointer _cycleStateEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(MM_SegregatedGC.__cycleStateOffset_));
	}
	...
	public MM_ParallelDispatcherPointer _dispatcher() throws CorruptDataException {
		return MM_ParallelDispatcherPointer.cast(getPointerAtOffset(MM_SegregatedGC.__dispatcherOffset_));
	}

	// MM_ParallelDispatcher* _dispatcher
	public PointerPointer _dispatcherEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(MM_SegregatedGC.__dispatcherOffset_));
	}
	...
	public MM_GCExtensionsBasePointer _extensions() throws CorruptDataException {
		return MM_GCExtensionsBasePointer.cast(getPointerAtOffset(MM_SegregatedGC.__extensionsOffset_));
	}

	// MM_GCExtensionsBase* _extensions
	public PointerPointer _extensionsEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(MM_SegregatedGC.__extensionsOffset_));
	}
	...
	public MM_SegregatedMarkingSchemePointer _markingScheme() throws CorruptDataException {
		return MM_SegregatedMarkingSchemePointer.cast(getPointerAtOffset(MM_SegregatedGC.__markingSchemeOffset_));
	}

	// MM_SegregatedMarkingScheme* _markingScheme
	public PointerPointer _markingSchemeEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(MM_SegregatedGC.__markingSchemeOffset_));
	}
	...
	public UDATAPointer _objectsMarkedEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_SegregatedGC.__objectsMarkedOffset_));
	}
	...
	public OMRPortLibraryPointer _portLibrary() throws CorruptDataException {
		return OMRPortLibraryPointer.cast(getPointerAtOffset(MM_SegregatedGC.__portLibraryOffset_));
	}

	// OMRPortLibrary* _portLibrary
	public PointerPointer _portLibraryEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(MM_SegregatedGC.__portLibraryOffset_));
	}
	...
	public UDATAPointer _scanBytesEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_SegregatedGC.__scanBytesOffset_));
	}
	...
	public MM_SweepSchemeSegregatedPointer _sweepScheme() throws CorruptDataException {
		return MM_SweepSchemeSegregatedPointer.cast(getPointerAtOffset(MM_SegregatedGC.__sweepSchemeOffset_));
	}

	// MM_SweepSchemeSegregated* _sweepScheme
	public PointerPointer _sweepSchemeEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(MM_SegregatedGC.__sweepSchemeOffset_));
	}
