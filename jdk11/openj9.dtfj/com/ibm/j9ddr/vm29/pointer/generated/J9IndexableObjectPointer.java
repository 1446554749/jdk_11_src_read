...
/**
 * Structure: J9IndexableObjectPointer
 *
 ...
 *
 * The generated code will provide getters for all elements in the J9IndexableObjectPointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=J9IndexableObject.class)
...
/*[END USER CODE]*/
	...
	public J9IndexableObjectPointer add(long count) {
		return J9IndexableObjectPointer.cast(address + (J9IndexableObject.SIZEOF * count));
	}
	...
	public J9IndexableObjectPointer addOffset(long offset) {
		return J9IndexableObjectPointer.cast(address + offset);
	}
	...
	public J9IndexableObjectPointer untag(long mask) {
		return J9IndexableObjectPointer.cast(address & ~mask);
	}
