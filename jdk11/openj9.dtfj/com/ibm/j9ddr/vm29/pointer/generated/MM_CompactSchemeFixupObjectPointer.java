...
/**
 * Structure: MM_CompactSchemeFixupObjectPointer
 *
 ...
 *
 * The generated code will provide getters for all elements in the MM_CompactSchemeFixupObjectPointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=MM_CompactSchemeFixupObject.class)
...
/*[END USER CODE]*/
	...
	protected MM_CompactSchemeFixupObjectPointer(long address) {
		super(address);
	}

	public static MM_CompactSchemeFixupObjectPointer cast(AbstractPointer structure) {
	...
	public static MM_CompactSchemeFixupObjectPointer cast(long address) {
		if (address == 0) {
			return NULL;
		}
		return new MM_CompactSchemeFixupObjectPointer(address);
	}

	public MM_CompactSchemeFixupObjectPointer add(long count) {
		return MM_CompactSchemeFixupObjectPointer.cast(address + (MM_CompactSchemeFixupObject.SIZEOF * count));
	}

	public MM_CompactSchemeFixupObjectPointer add(Scalar count) {
		return add(count.longValue());
	}

	public MM_CompactSchemeFixupObjectPointer addOffset(long offset) {
		return MM_CompactSchemeFixupObjectPointer.cast(address + offset);
	}

	public MM_CompactSchemeFixupObjectPointer addOffset(Scalar offset) {
		return addOffset(offset.longValue());
	}

	public MM_CompactSchemeFixupObjectPointer sub(long count) {
		return MM_CompactSchemeFixupObjectPointer.cast(address - (MM_CompactSchemeFixupObject.SIZEOF * count));
	}

	public MM_CompactSchemeFixupObjectPointer sub(Scalar count) {
		return sub(count.longValue());
	}

	public MM_CompactSchemeFixupObjectPointer subOffset(long offset) {
		return MM_CompactSchemeFixupObjectPointer.cast(address - offset);
	}

	public MM_CompactSchemeFixupObjectPointer subOffset(Scalar offset) {
		return subOffset(offset.longValue());
	}

	public MM_CompactSchemeFixupObjectPointer untag(long mask) {
		return MM_CompactSchemeFixupObjectPointer.cast(address & ~mask);
	}
