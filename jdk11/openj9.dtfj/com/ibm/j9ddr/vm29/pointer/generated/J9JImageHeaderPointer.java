...
/*[END USER CODE]*/
	...
	public JImageHeaderPointer jimageHeader() throws CorruptDataException {
		return JImageHeaderPointer.cast(getPointerAtOffset(J9JImageHeader._jimageHeaderOffset_));
	}

	// JImageHeader* jimageHeader
	public PointerPointer jimageHeaderEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9JImageHeader._jimageHeaderOffset_));
	}
	...
	public PointerPointer locationsDataEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9JImageHeader._locationsDataOffset_));
	}
	...
	public PointerPointer locationsOffsetTableEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9JImageHeader._locationsOffsetTableOffset_));
	}
	...
	public PointerPointer redirectTableEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9JImageHeader._redirectTableOffset_));
	}
	...
	public UDATAPointer resourcesEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(J9JImageHeader._resourcesOffset_));
	}
	...
	public PointerPointer stringsDataEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9JImageHeader._stringsDataOffset_));
	}
