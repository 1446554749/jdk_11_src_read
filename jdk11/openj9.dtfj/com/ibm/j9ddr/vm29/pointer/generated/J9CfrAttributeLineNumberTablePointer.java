...
/**
 * Structure: J9CfrAttributeLineNumberTablePointer
 *
 ...
 *
 * The generated code will provide getters for all elements in the J9CfrAttributeLineNumberTablePointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=J9CfrAttributeLineNumberTable.class)
...
/*[END USER CODE]*/
	...
	protected J9CfrAttributeLineNumberTablePointer(long address) {
		super(address);
	}

	public static J9CfrAttributeLineNumberTablePointer cast(AbstractPointer structure) {
	...
	public static J9CfrAttributeLineNumberTablePointer cast(long address) {
		if (address == 0) {
			return NULL;
		}
		return new J9CfrAttributeLineNumberTablePointer(address);
	}

	public J9CfrAttributeLineNumberTablePointer add(long count) {
		return J9CfrAttributeLineNumberTablePointer.cast(address + (J9CfrAttributeLineNumberTable.SIZEOF * count));
	}

	public J9CfrAttributeLineNumberTablePointer add(Scalar count) {
		return add(count.longValue());
	}

	public J9CfrAttributeLineNumberTablePointer addOffset(long offset) {
		return J9CfrAttributeLineNumberTablePointer.cast(address + offset);
	}

	public J9CfrAttributeLineNumberTablePointer addOffset(Scalar offset) {
		return addOffset(offset.longValue());
	}

	public J9CfrAttributeLineNumberTablePointer sub(long count) {
		return J9CfrAttributeLineNumberTablePointer.cast(address - (J9CfrAttributeLineNumberTable.SIZEOF * count));
	}

	public J9CfrAttributeLineNumberTablePointer sub(Scalar count) {
		return sub(count.longValue());
	}

	public J9CfrAttributeLineNumberTablePointer subOffset(long offset) {
		return J9CfrAttributeLineNumberTablePointer.cast(address - offset);
	}

	public J9CfrAttributeLineNumberTablePointer subOffset(Scalar offset) {
		return subOffset(offset.longValue());
	}

	public J9CfrAttributeLineNumberTablePointer untag(long mask) {
		return J9CfrAttributeLineNumberTablePointer.cast(address & ~mask);
	}
	...
	// U32 j9EndPC
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="_j9EndPCOffset_", declaredType="U32")
	public UDATA j9EndPC() throws CorruptDataException {
		return new U32(getIntAtOffset(J9CfrAttributeLineNumberTable._j9EndPCOffset_));
	}

	// U32 j9EndPC
	public UDATAPointer j9EndPCEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(J9CfrAttributeLineNumberTable._j9EndPCOffset_));
	}

	// U32 j9StartPC
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="_j9StartPCOffset_", declaredType="U32")
	public UDATA j9StartPC() throws CorruptDataException {
		return new U32(getIntAtOffset(J9CfrAttributeLineNumberTable._j9StartPCOffset_));
	}

	// U32 j9StartPC
	public UDATAPointer j9StartPCEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(J9CfrAttributeLineNumberTable._j9StartPCOffset_));
	}
	...
	public UDATAPointer lengthEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(J9CfrAttributeLineNumberTable._lengthOffset_));
	}

	// J9CfrLineNumberTableEntry* lineNumberTable
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="_lineNumberTableOffset_", declaredType="J9CfrLineNumberTableEntry*")
	...
	// U16 lineNumberTableLength
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="_lineNumberTableLengthOffset_", declaredType="U16")
