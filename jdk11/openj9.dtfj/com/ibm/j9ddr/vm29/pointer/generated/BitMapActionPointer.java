 ...
 *
 * The generated code will provide getters for all elements in the BitMapActionPointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=BitMapAction.class)
public class BitMapActionPointer extends StructurePointer {

	// NULL
	public static final BitMapActionPointer NULL = new BitMapActionPointer(0);
...
/*[END USER CODE]*/
	...
	public BitMapActionPointer add(long count) {
		return BitMapActionPointer.cast(address + (BitMapAction.SIZEOF * count));
	}
	...
	public BitMapActionPointer addOffset(long offset) {
		return BitMapActionPointer.cast(address + offset);
	}
	...
	public BitMapActionPointer untag(long mask) {
		return BitMapActionPointer.cast(address & ~mask);
	}
