...
/**
 * Structure: J9IndexableObjectContiguousCompressedPointer
 *
 ...
 *
 * The generated code will provide getters for all elements in the J9IndexableObjectContiguousCompressedPointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=J9IndexableObjectContiguousCompressed.class)
...
/*[END USER CODE]*/
	...
	protected J9IndexableObjectContiguousCompressedPointer(long address) {
		super(address);
	}

	public static J9IndexableObjectContiguousCompressedPointer cast(AbstractPointer structure) {
	...
	public static J9IndexableObjectContiguousCompressedPointer cast(long address) {
		if (address == 0) {
			return NULL;
		}
		return new J9IndexableObjectContiguousCompressedPointer(address);
	}

	public J9IndexableObjectContiguousCompressedPointer add(long count) {
		return J9IndexableObjectContiguousCompressedPointer.cast(address + (J9IndexableObjectContiguousCompressed.SIZEOF * count));
	}

	public J9IndexableObjectContiguousCompressedPointer add(Scalar count) {
		return add(count.longValue());
	}

	public J9IndexableObjectContiguousCompressedPointer addOffset(long offset) {
		return J9IndexableObjectContiguousCompressedPointer.cast(address + offset);
	}

	public J9IndexableObjectContiguousCompressedPointer addOffset(Scalar offset) {
		return addOffset(offset.longValue());
	}

	public J9IndexableObjectContiguousCompressedPointer sub(long count) {
		return J9IndexableObjectContiguousCompressedPointer.cast(address - (J9IndexableObjectContiguousCompressed.SIZEOF * count));
	}

	public J9IndexableObjectContiguousCompressedPointer sub(Scalar count) {
		return sub(count.longValue());
	}

	public J9IndexableObjectContiguousCompressedPointer subOffset(long offset) {
		return J9IndexableObjectContiguousCompressedPointer.cast(address - offset);
	}

	public J9IndexableObjectContiguousCompressedPointer subOffset(Scalar offset) {
		return subOffset(offset.longValue());
	}

	public J9IndexableObjectContiguousCompressedPointer untag(long mask) {
		return J9IndexableObjectContiguousCompressedPointer.cast(address & ~mask);
	}
