...
/*[END USER CODE]*/
	...
	public UDATA pc() throws CorruptDataException {
		return getUDATAAtOffset(J9BranchTargetStack._pcOffset_);
	}

	// UDATA pc
	public UDATAPointer pcEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(J9BranchTargetStack._pcOffset_));
	}
	...
	public IDATA stackBaseIndex() throws CorruptDataException {
		return getIDATAAtOffset(J9BranchTargetStack._stackBaseIndexOffset_);
	}

	// IDATA stackBaseIndex
	public IDATAPointer stackBaseIndexEA() throws CorruptDataException {
		return IDATAPointer.cast(nonNullFieldEA(J9BranchTargetStack._stackBaseIndexOffset_));
	}

	// UDATA[] stackElements
	public UDATAPointer stackElementsEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(J9BranchTargetStack._stackElementsOffset_));
	}
	...
	public IDATA stackTopIndex() throws CorruptDataException {
		return getIDATAAtOffset(J9BranchTargetStack._stackTopIndexOffset_);
	}

	// IDATA stackTopIndex
	public IDATAPointer stackTopIndexEA() throws CorruptDataException {
		return IDATAPointer.cast(nonNullFieldEA(J9BranchTargetStack._stackTopIndexOffset_));
	}
	...
	public UDATA uninitializedThis() throws CorruptDataException {
		return getUDATAAtOffset(J9BranchTargetStack._uninitializedThisOffset_);
	}

	// UDATA uninitializedThis
	public UDATAPointer uninitializedThisEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(J9BranchTargetStack._uninitializedThisOffset_));
	}
