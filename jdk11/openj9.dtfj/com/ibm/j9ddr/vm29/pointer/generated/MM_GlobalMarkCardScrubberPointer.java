...
/*[END USER CODE]*/
	...
	public UDATA _countBeforeYieldCheck() throws CorruptDataException {
		return getUDATAAtOffset(MM_GlobalMarkCardScrubber.__countBeforeYieldCheckOffset_);
	}

	// UDATA _countBeforeYieldCheck
	public UDATAPointer _countBeforeYieldCheckEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_GlobalMarkCardScrubber.__countBeforeYieldCheckOffset_));
	}
	...
	public MM_InterRegionRememberedSetPointer _interRegionRememberedSet() throws CorruptDataException {
		return MM_InterRegionRememberedSetPointer.cast(getPointerAtOffset(MM_GlobalMarkCardScrubber.__interRegionRememberedSetOffset_));
	}

	// const MM_InterRegionRememberedSet* _interRegionRememberedSet
	public PointerPointer _interRegionRememberedSetEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(MM_GlobalMarkCardScrubber.__interRegionRememberedSetOffset_));
	}
	...
	public MM_HeapMapPointer _markMap() throws CorruptDataException {
		return MM_HeapMapPointer.cast(getPointerAtOffset(MM_GlobalMarkCardScrubber.__markMapOffset_));
	}

	// const MM_HeapMap* _markMap
	public PointerPointer _markMapEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(MM_GlobalMarkCardScrubber.__markMapOffset_));
	}
	...
	public UDATA _statistics$_dirtyCards() throws CorruptDataException {
		return getUDATAAtOffset(MM_GlobalMarkCardScrubber.__statistics$_dirtyCardsOffset_);
	}

	// UDATA _statistics._dirtyCards
	public UDATAPointer _statistics$_dirtyCardsEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_GlobalMarkCardScrubber.__statistics$_dirtyCardsOffset_));
	}
	...
	public UDATA _statistics$_gmpMustScanCards() throws CorruptDataException {
		return getUDATAAtOffset(MM_GlobalMarkCardScrubber.__statistics$_gmpMustScanCardsOffset_);
	}

	// UDATA _statistics._gmpMustScanCards
	public UDATAPointer _statistics$_gmpMustScanCardsEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_GlobalMarkCardScrubber.__statistics$_gmpMustScanCardsOffset_));
	}
	...
	public UDATA _statistics$_scrubbedCards() throws CorruptDataException {
		return getUDATAAtOffset(MM_GlobalMarkCardScrubber.__statistics$_scrubbedCardsOffset_);
	}

	// UDATA _statistics._scrubbedCards
	public UDATAPointer _statistics$_scrubbedCardsEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_GlobalMarkCardScrubber.__statistics$_scrubbedCardsOffset_));
	}
	...
	public UDATA _statistics$_scrubbedObjects() throws CorruptDataException {
		return getUDATAAtOffset(MM_GlobalMarkCardScrubber.__statistics$_scrubbedObjectsOffset_);
	}

	// UDATA _statistics._scrubbedObjects
	public UDATAPointer _statistics$_scrubbedObjectsEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_GlobalMarkCardScrubber.__statistics$_scrubbedObjectsOffset_));
	}
	...
	public UDATA _yieldCheckFrequency() throws CorruptDataException {
		return getUDATAAtOffset(MM_GlobalMarkCardScrubber.__yieldCheckFrequencyOffset_);
	}

	// const UDATA _yieldCheckFrequency
	public UDATAPointer _yieldCheckFrequencyEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_GlobalMarkCardScrubber.__yieldCheckFrequencyOffset_));
	}
