 ...
 *
 * The generated code will provide getters for all elements in the UnitTestPointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=UnitTest.class)
public class UnitTestPointer extends StructurePointer {

	// NULL
	public static final UnitTestPointer NULL = new UnitTestPointer(0);
...
/*[END USER CODE]*/
	...
	public UnitTestPointer add(long count) {
		return UnitTestPointer.cast(address + (UnitTest.SIZEOF * count));
	}
	...
	public UnitTestPointer addOffset(long offset) {
		return UnitTestPointer.cast(address + offset);
	}
	...
	public UnitTestPointer untag(long mask) {
		return UnitTestPointer.cast(address & ~mask);
	}
