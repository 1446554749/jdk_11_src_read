...
/*[END USER CODE]*/
	...
	public UDATAPointer _currentCycleEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_VerboseWriterFileLogging.__currentCycleOffset_));
	}
	...
	public UDATAPointer _currentFileEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_VerboseWriterFileLogging.__currentFileOffset_));
	}
	...
	public PointerPointer _filenameEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(MM_VerboseWriterFileLogging.__filenameOffset_));
	}
	...
	public MM_VerboseManagerPointer _manager() throws CorruptDataException {
		return MM_VerboseManagerPointer.cast(getPointerAtOffset(MM_VerboseWriterFileLogging.__managerOffset_));
	}

	// MM_VerboseManager* _manager
	public PointerPointer _managerEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(MM_VerboseWriterFileLogging.__managerOffset_));
	}
	...
	public UDATAPointer _modeEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_VerboseWriterFileLogging.__modeOffset_));
	}
	...
	public UDATAPointer _numCyclesEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_VerboseWriterFileLogging.__numCyclesOffset_));
	}
	...
	public UDATAPointer _numFilesEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_VerboseWriterFileLogging.__numFilesOffset_));
	}
	...
	public J9StringTokensPointer _tokens() throws CorruptDataException {
		return J9StringTokensPointer.cast(getPointerAtOffset(MM_VerboseWriterFileLogging.__tokensOffset_));
	}

	// J9StringTokens* _tokens
	public PointerPointer _tokensEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(MM_VerboseWriterFileLogging.__tokensOffset_));
	}
