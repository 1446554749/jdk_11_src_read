...
/*[END USER CODE]*/
	...
	// key_t _key
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="__keyOffset_", declaredType="key_t")
	public IDATA _key() throws CorruptDataException {
		return new I32(getIntAtOffset(ipc_perm.__keyOffset_));
	}

	// key_t _key
	public IDATAPointer _keyEA() throws CorruptDataException {
		return IDATAPointer.cast(nonNullFieldEA(ipc_perm.__keyOffset_));
	}

	// U16 _seq
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="__seqOffset_", declaredType="U16")
	public U16 _seq() throws CorruptDataException {
		return new U16(getShortAtOffset(ipc_perm.__seqOffset_));
	}

	// U16 _seq
	public U16Pointer _seqEA() throws CorruptDataException {
		return U16Pointer.cast(nonNullFieldEA(ipc_perm.__seqOffset_));
	}
	...
	public U16 mode() throws CorruptDataException {
		return new U16(getShortAtOffset(ipc_perm._modeOffset_));
	}

	// mode_t mode
	public U16Pointer modeEA() throws CorruptDataException {
		return U16Pointer.cast(nonNullFieldEA(ipc_perm._modeOffset_));
	}
