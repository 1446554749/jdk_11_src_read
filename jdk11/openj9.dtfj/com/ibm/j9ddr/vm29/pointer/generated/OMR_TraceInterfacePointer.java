...
/**
 * Structure: OMR_TraceInterfacePointer
 *
 ...
 *
 * The generated code will provide getters for all elements in the OMR_TraceInterfacePointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=OMR_TraceInterface.class)
...
/*[END USER CODE]*/
	...
	protected OMR_TraceInterfacePointer(long address) {
		super(address);
	}

	public static OMR_TraceInterfacePointer cast(AbstractPointer structure) {
	...
	public static OMR_TraceInterfacePointer cast(long address) {
		if (address == 0) {
			return NULL;
		}
		return new OMR_TraceInterfacePointer(address);
	}

	public OMR_TraceInterfacePointer add(long count) {
		return OMR_TraceInterfacePointer.cast(address + (OMR_TraceInterface.SIZEOF * count));
	}

	public OMR_TraceInterfacePointer add(Scalar count) {
		return add(count.longValue());
	}

	public OMR_TraceInterfacePointer addOffset(long offset) {
		return OMR_TraceInterfacePointer.cast(address + offset);
	}

	public OMR_TraceInterfacePointer addOffset(Scalar offset) {
		return addOffset(offset.longValue());
	}

	public OMR_TraceInterfacePointer sub(long count) {
		return OMR_TraceInterfacePointer.cast(address - (OMR_TraceInterface.SIZEOF * count));
	}

	public OMR_TraceInterfacePointer sub(Scalar count) {
		return sub(count.longValue());
	}

	public OMR_TraceInterfacePointer subOffset(long offset) {
		return OMR_TraceInterfacePointer.cast(address - offset);
	}

	public OMR_TraceInterfacePointer subOffset(Scalar offset) {
		return subOffset(offset.longValue());
	}

	public OMR_TraceInterfacePointer untag(long mask) {
		return OMR_TraceInterfacePointer.cast(address & ~mask);
	}
	...
	public PointerPointer DeregisterRecordSubscriberEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(OMR_TraceInterface._DeregisterRecordSubscriberOffset_));
	}
	...
	public PointerPointer FlushTraceDataEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(OMR_TraceInterface._FlushTraceDataOffset_));
	}
	...
	public PointerPointer GetTraceMetadataEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(OMR_TraceInterface._GetTraceMetadataOffset_));
	}
	...
	public PointerPointer RegisterRecordSubscriberEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(OMR_TraceInterface._RegisterRecordSubscriberOffset_));
	}
	...
	public PointerPointer SetOptionsEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(OMR_TraceInterface._SetOptionsOffset_));
	}
