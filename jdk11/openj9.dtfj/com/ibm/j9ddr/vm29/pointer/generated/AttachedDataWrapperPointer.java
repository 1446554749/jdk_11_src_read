...
/*[END USER CODE]*/
	...
	public J9ShrOffsetPointer cacheOffset() throws CorruptDataException {
		return J9ShrOffsetPointer.cast(nonNullFieldEA(AttachedDataWrapper._cacheOffsetOffset_));
	}

	// J9ShrOffset cacheOffset
	public PointerPointer cacheOffsetEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(AttachedDataWrapper._cacheOffsetOffset_));
	}
	...
	public IDATAPointer corruptEA() throws CorruptDataException {
		return IDATAPointer.cast(nonNullFieldEA(AttachedDataWrapper._corruptOffset_));
	}
	...
	public UDATAPointer dataLengthEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(AttachedDataWrapper._dataLengthOffset_));
	}
	...
	public U16Pointer typeEA() throws CorruptDataException {
		return U16Pointer.cast(nonNullFieldEA(AttachedDataWrapper._typeOffset_));
	}
	...
	public U16Pointer updateCountEA() throws CorruptDataException {
		return U16Pointer.cast(nonNullFieldEA(AttachedDataWrapper._updateCountOffset_));
	}
