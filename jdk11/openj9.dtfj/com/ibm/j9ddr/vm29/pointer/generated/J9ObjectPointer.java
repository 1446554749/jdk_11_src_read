 ...
 *
 * The generated code will provide getters for all elements in the J9ObjectPointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=J9Object.class)
public class J9ObjectPointer extends StructurePointer {

	// NULL
	public static final J9ObjectPointer NULL = new J9ObjectPointer(0);
...
/*[END USER CODE]*/
	...
	public J9ObjectPointer add(long count) {
		return J9ObjectPointer.cast(address + (J9Object.SIZEOF * count));
	}
	...
	public J9ObjectPointer addOffset(long offset) {
		return J9ObjectPointer.cast(address + offset);
	}
	...
	public J9ObjectPointer untag(long mask) {
		return J9ObjectPointer.cast(address & ~mask);
	}
	...
	public ObjectClassReferencePointer clazzEA() throws CorruptDataException {
		return ObjectClassReferencePointer.cast(nonNullFieldEA(J9Object._clazzOffset_));
	}
