...
/**
 * Structure: OMRTraceLanguageInterfacePointer
 *
 ...
 *
 * The generated code will provide getters for all elements in the OMRTraceLanguageInterfacePointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=OMRTraceLanguageInterface.class)
...
/*[END USER CODE]*/
	...
	protected OMRTraceLanguageInterfacePointer(long address) {
		super(address);
	}

	public static OMRTraceLanguageInterfacePointer cast(AbstractPointer structure) {
	...
	public static OMRTraceLanguageInterfacePointer cast(long address) {
		if (address == 0) {
			return NULL;
		}
		return new OMRTraceLanguageInterfacePointer(address);
	}

	public OMRTraceLanguageInterfacePointer add(long count) {
		return OMRTraceLanguageInterfacePointer.cast(address + (OMRTraceLanguageInterface.SIZEOF * count));
	}

	public OMRTraceLanguageInterfacePointer add(Scalar count) {
		return add(count.longValue());
	}

	public OMRTraceLanguageInterfacePointer addOffset(long offset) {
		return OMRTraceLanguageInterfacePointer.cast(address + offset);
	}

	public OMRTraceLanguageInterfacePointer addOffset(Scalar offset) {
		return addOffset(offset.longValue());
	}

	public OMRTraceLanguageInterfacePointer sub(long count) {
		return OMRTraceLanguageInterfacePointer.cast(address - (OMRTraceLanguageInterface.SIZEOF * count));
	}

	public OMRTraceLanguageInterfacePointer sub(Scalar count) {
		return sub(count.longValue());
	}

	public OMRTraceLanguageInterfacePointer subOffset(long offset) {
		return OMRTraceLanguageInterfacePointer.cast(address - offset);
	}

	public OMRTraceLanguageInterfacePointer subOffset(Scalar offset) {
		return subOffset(offset.longValue());
	}

	public OMRTraceLanguageInterfacePointer untag(long mask) {
		return OMRTraceLanguageInterfacePointer.cast(address & ~mask);
	}
	...
	// void* AttachCurrentThreadToLanguageVM
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="_AttachCurrentThreadToLanguageVMOffset_", declaredType="void*")
	...
	// void* DetachCurrentThreadFromLanguageVM
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="_DetachCurrentThreadFromLanguageVMOffset_", declaredType="void*")
	...
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="_ReportCommandLineErrorOffset_", declaredType="ReportCommandLineErrorFunc")
	...
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="_SetLanguageTraceOptionOffset_", declaredType="SetLanguageTraceOptionFunc")
