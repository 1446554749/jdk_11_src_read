...
/*[END USER CODE]*/
	...
	public MM_ParallelDispatcherPointer dispatcher() throws CorruptDataException {
		return MM_ParallelDispatcherPointer.cast(getPointerAtOffset(workerThreadInfo._dispatcherOffset_));
	}

	// MM_ParallelDispatcher* dispatcher
	public PointerPointer dispatcherEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(workerThreadInfo._dispatcherOffset_));
	}
	...
	public OMR_VMPointer omrVM() throws CorruptDataException {
		return OMR_VMPointer.cast(getPointerAtOffset(workerThreadInfo._omrVMOffset_));
	}

	// OMR_VM* omrVM
	public PointerPointer omrVMEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(workerThreadInfo._omrVMOffset_));
	}
	...
	public UDATAPointer workerFlagsEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(workerThreadInfo._workerFlagsOffset_));
	}
	...
	public UDATAPointer workerIDEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(workerThreadInfo._workerIDOffset_));
	}
