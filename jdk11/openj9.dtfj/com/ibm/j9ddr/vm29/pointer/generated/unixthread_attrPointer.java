...
/*[END USER CODE]*/
	...
	public omrthread_attrPointer hdr() throws CorruptDataException {
		return omrthread_attrPointer.cast(nonNullFieldEA(unixthread_attr._hdrOffset_));
	}

	// omrthread_attr hdr
	public PointerPointer hdrEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(unixthread_attr._hdrOffset_));
	}
	...
	public _opaque_pthread_attr_tPointer pattr() throws CorruptDataException {
		return _opaque_pthread_attr_tPointer.cast(nonNullFieldEA(unixthread_attr._pattrOffset_));
	}

	// pthread_attr_t pattr
	public PointerPointer pattrEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(unixthread_attr._pattrOffset_));
	}
