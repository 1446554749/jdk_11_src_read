 ...
 *
 * The generated code will provide getters for all elements in the UtDataHeaderPointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=UtDataHeader.class)
public class UtDataHeaderPointer extends StructurePointer {

	// NULL
	public static final UtDataHeaderPointer NULL = new UtDataHeaderPointer(0);
...
/*[END USER CODE]*/
	...
	public UtDataHeaderPointer add(long count) {
		return UtDataHeaderPointer.cast(address + (UtDataHeader.SIZEOF * count));
	}
	...
	public UtDataHeaderPointer addOffset(long offset) {
		return UtDataHeaderPointer.cast(address + offset);
	}
	...
	public UtDataHeaderPointer untag(long mask) {
		return UtDataHeaderPointer.cast(address & ~mask);
	}
	...
	public U8Pointer eyecatcherEA() throws CorruptDataException {
		return U8Pointer.cast(nonNullFieldEA(UtDataHeader._eyecatcherOffset_));
	}
	...
	public IDATA length() throws CorruptDataException {
		return new I32(getIntAtOffset(UtDataHeader._lengthOffset_));
	}

	// I32 length
	public IDATAPointer lengthEA() throws CorruptDataException {
		return IDATAPointer.cast(nonNullFieldEA(UtDataHeader._lengthOffset_));
	}
	...
	public IDATA modification() throws CorruptDataException {
		return new I32(getIntAtOffset(UtDataHeader._modificationOffset_));
	}

	// I32 modification
	public IDATAPointer modificationEA() throws CorruptDataException {
		return IDATAPointer.cast(nonNullFieldEA(UtDataHeader._modificationOffset_));
	}
	...
	public IDATA version() throws CorruptDataException {
		return new I32(getIntAtOffset(UtDataHeader._versionOffset_));
	}

	// I32 version
	public IDATAPointer versionEA() throws CorruptDataException {
		return IDATAPointer.cast(nonNullFieldEA(UtDataHeader._versionOffset_));
	}
