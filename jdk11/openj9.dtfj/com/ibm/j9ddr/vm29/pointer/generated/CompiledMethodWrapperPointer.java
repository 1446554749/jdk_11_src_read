...
/**
 * Structure: CompiledMethodWrapperPointer
 *
 ...
 *
 * The generated code will provide getters for all elements in the CompiledMethodWrapperPointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=CompiledMethodWrapper.class)
public class CompiledMethodWrapperPointer extends StructurePointer {

	// NULL
	public static final CompiledMethodWrapperPointer NULL = new CompiledMethodWrapperPointer(0);
...
/*[END USER CODE]*/
	...
	public CompiledMethodWrapperPointer add(long count) {
		return CompiledMethodWrapperPointer.cast(address + (CompiledMethodWrapper.SIZEOF * count));
	}
	...
	public CompiledMethodWrapperPointer addOffset(long offset) {
		return CompiledMethodWrapperPointer.cast(address + offset);
	}
	...
	public CompiledMethodWrapperPointer untag(long mask) {
		return CompiledMethodWrapperPointer.cast(address & ~mask);
	}
	...
	public UDATA codeLength() throws CorruptDataException {
		return new U32(getIntAtOffset(CompiledMethodWrapper._codeLengthOffset_));
	}

	// U32 codeLength
	public UDATAPointer codeLengthEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(CompiledMethodWrapper._codeLengthOffset_));
	}
	...
	public UDATA dataLength() throws CorruptDataException {
		return new U32(getIntAtOffset(CompiledMethodWrapper._dataLengthOffset_));
	}

	// U32 dataLength
	public UDATAPointer dataLengthEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(CompiledMethodWrapper._dataLengthOffset_));
	}

	// J9ShrOffset romMethodOffset
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="_romMethodOffsetOffset_", declaredType="J9ShrOffset")
	public J9ShrOffsetPointer romMethodOffset() throws CorruptDataException {
		return J9ShrOffsetPointer.cast(nonNullFieldEA(CompiledMethodWrapper._romMethodOffsetOffset_));
	}

	// J9ShrOffset romMethodOffset
	public PointerPointer romMethodOffsetEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(CompiledMethodWrapper._romMethodOffsetOffset_));
	}
