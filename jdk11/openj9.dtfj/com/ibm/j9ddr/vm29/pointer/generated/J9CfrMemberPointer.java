 ...
 *
 * The generated code will provide getters for all elements in the J9CfrMemberPointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=J9CfrMember.class)
public class J9CfrMemberPointer extends StructurePointer {

	// NULL
	public static final J9CfrMemberPointer NULL = new J9CfrMemberPointer(0);
...
/*[END USER CODE]*/
	...
	public J9CfrMemberPointer add(long count) {
		return J9CfrMemberPointer.cast(address + (J9CfrMember.SIZEOF * count));
	}
	...
	public J9CfrMemberPointer addOffset(long offset) {
		return J9CfrMemberPointer.cast(address + offset);
	}
	...
	public J9CfrMemberPointer untag(long mask) {
		return J9CfrMemberPointer.cast(address & ~mask);
	}
	...
	public U16 accessFlags() throws CorruptDataException {
		return new U16(getShortAtOffset(J9CfrMember._accessFlagsOffset_));
	}

	// U16 accessFlags
	public U16Pointer accessFlagsEA() throws CorruptDataException {
		return U16Pointer.cast(nonNullFieldEA(J9CfrMember._accessFlagsOffset_));
	}
	...
	public PointerPointer attributes() throws CorruptDataException {
		return PointerPointer.cast(getPointerAtOffset(J9CfrMember._attributesOffset_));
	}

	// void** attributes
	public PointerPointer attributesEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9CfrMember._attributesOffset_));
	}
	...
	public U16 attributesCount() throws CorruptDataException {
		return new U16(getShortAtOffset(J9CfrMember._attributesCountOffset_));
	}

	// U16 attributesCount
	public U16Pointer attributesCountEA() throws CorruptDataException {
		return U16Pointer.cast(nonNullFieldEA(J9CfrMember._attributesCountOffset_));
	}
	...
	public U16 descriptorIndex() throws CorruptDataException {
		return new U16(getShortAtOffset(J9CfrMember._descriptorIndexOffset_));
	}

	// U16 descriptorIndex
	public U16Pointer descriptorIndexEA() throws CorruptDataException {
		return U16Pointer.cast(nonNullFieldEA(J9CfrMember._descriptorIndexOffset_));
	}
	...
	public U16 nameIndex() throws CorruptDataException {
		return new U16(getShortAtOffset(J9CfrMember._nameIndexOffset_));
	}

	// U16 nameIndex
	public U16Pointer nameIndexEA() throws CorruptDataException {
		return U16Pointer.cast(nonNullFieldEA(J9CfrMember._nameIndexOffset_));
	}
	...
	public UDATA romAddress() throws CorruptDataException {
		return getUDATAAtOffset(J9CfrMember._romAddressOffset_);
	}

	// UDATA romAddress
	public UDATAPointer romAddressEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(J9CfrMember._romAddressOffset_));
	}
