 ...
 *
 * The generated code will provide getters for all elements in the J9MmapHandlePointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=J9MmapHandle.class)
...
/*[END USER CODE]*/
	...
	protected J9MmapHandlePointer(long address) {
		super(address);
	}

	public static J9MmapHandlePointer cast(AbstractPointer structure) {
	...
	public static J9MmapHandlePointer cast(long address) {
		if (address == 0) {
			return NULL;
		}
		return new J9MmapHandlePointer(address);
	}

	public J9MmapHandlePointer add(long count) {
		return J9MmapHandlePointer.cast(address + (J9MmapHandle.SIZEOF * count));
	}

	public J9MmapHandlePointer add(Scalar count) {
		return add(count.longValue());
	}

	public J9MmapHandlePointer addOffset(long offset) {
		return J9MmapHandlePointer.cast(address + offset);
	}

	public J9MmapHandlePointer addOffset(Scalar offset) {
		return addOffset(offset.longValue());
	}

	public J9MmapHandlePointer sub(long count) {
		return J9MmapHandlePointer.cast(address - (J9MmapHandle.SIZEOF * count));
	}

	public J9MmapHandlePointer sub(Scalar count) {
		return sub(count.longValue());
	}

	public J9MmapHandlePointer subOffset(long offset) {
		return J9MmapHandlePointer.cast(address - offset);
	}

	public J9MmapHandlePointer subOffset(Scalar offset) {
		return subOffset(offset.longValue());
	}

	public J9MmapHandlePointer untag(long mask) {
		return J9MmapHandlePointer.cast(address & ~mask);
	}
	...
	// void* allocPointer
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="_allocPointerOffset_", declaredType="void*")
	...
	public OMRMemCategoryPointer category() throws CorruptDataException {
		return OMRMemCategoryPointer.cast(getPointerAtOffset(J9MmapHandle._categoryOffset_));
	}
	...
	public UDATA size() throws CorruptDataException {
		return new U64(getLongAtOffset(J9MmapHandle._sizeOffset_));
	}
