 ...
 *
 * The generated code will provide getters for all elements in the KeyValuePairPointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=KeyValuePair.class)
public class KeyValuePairPointer extends StructurePointer {

	// NULL
	public static final KeyValuePairPointer NULL = new KeyValuePairPointer(0);
...
/*[END USER CODE]*/
	...
	public KeyValuePairPointer add(long count) {
		return KeyValuePairPointer.cast(address + (KeyValuePair.SIZEOF * count));
	}
	...
	public KeyValuePairPointer addOffset(long offset) {
		return KeyValuePairPointer.cast(address + offset);
	}
	...
	public KeyValuePairPointer untag(long mask) {
		return KeyValuePairPointer.cast(address & ~mask);
	}
	...
	public U8Pointer key() throws CorruptDataException {
		return U8Pointer.cast(getPointerAtOffset(KeyValuePair._keyOffset_));
	}

	// U8* key
	public PointerPointer keyEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(KeyValuePair._keyOffset_));
	}
	...
	public U8Pointer value() throws CorruptDataException {
		return U8Pointer.cast(getPointerAtOffset(KeyValuePair._valueOffset_));
	}

	// U8* value
	public PointerPointer valueEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(KeyValuePair._valueOffset_));
	}
