 ...
 *
 * The generated code will provide getters for all elements in the J9ConstsPointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=J9Consts.class)
public class J9ConstsPointer extends StructurePointer {

	// NULL
	public static final J9ConstsPointer NULL = new J9ConstsPointer(0);
...
/*[END USER CODE]*/
	...
	public J9ConstsPointer add(long count) {
		return J9ConstsPointer.cast(address + (J9Consts.SIZEOF * count));
	}
	...
	public J9ConstsPointer addOffset(long offset) {
		return J9ConstsPointer.cast(address + offset);
	}
	...
	public J9ConstsPointer untag(long mask) {
		return J9ConstsPointer.cast(address & ~mask);
	}
