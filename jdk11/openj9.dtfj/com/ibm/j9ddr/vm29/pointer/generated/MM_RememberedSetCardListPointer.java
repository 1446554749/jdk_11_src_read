...
/*[END USER CODE]*/
	...
	public BoolPointer _beingRebuiltEA() throws CorruptDataException {
		return BoolPointer.cast(nonNullFieldEA(MM_RememberedSetCardList.__beingRebuiltOffset_));
	}
	...
	public MM_RememberedSetCardBucketPointer _bucketListHead() throws CorruptDataException {
		return MM_RememberedSetCardBucketPointer.cast(getPointerAtOffset(MM_RememberedSetCardList.__bucketListHeadOffset_));
	}

	// MM_RememberedSetCardBucket* _bucketListHead
	public PointerPointer _bucketListHeadEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(MM_RememberedSetCardList.__bucketListHeadOffset_));
	}
	...
	public UDATA _bufferCount() throws CorruptDataException {
		return getUDATAAtOffset(MM_RememberedSetCardList.__bufferCountOffset_);
	}

	// volatile UDATA _bufferCount
	public UDATAPointer _bufferCountEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_RememberedSetCardList.__bufferCountOffset_));
	}
	...
	public UDATA _index() throws CorruptDataException {
		return getUDATAAtOffset(MM_RememberedSetCardList.__indexOffset_);
	}

	// UDATA _index
	public UDATAPointer _indexEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_RememberedSetCardList.__indexOffset_));
	}
	...
	public MM_RememberedSetCardListPointer _nonEmptyOverflowedNext() throws CorruptDataException {
		return MM_RememberedSetCardListPointer.cast(getPointerAtOffset(MM_RememberedSetCardList.__nonEmptyOverflowedNextOffset_));
	}

	// volatile MM_RememberedSetCardList* _nonEmptyOverflowedNext
	public PointerPointer _nonEmptyOverflowedNextEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(MM_RememberedSetCardList.__nonEmptyOverflowedNextOffset_));
	}
	...
	public UDATA _overflowed() throws CorruptDataException {
		return getUDATAAtOffset(MM_RememberedSetCardList.__overflowedOffset_);
	}

	// volatile UDATA _overflowed
	public UDATAPointer _overflowedEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_RememberedSetCardList.__overflowedOffset_));
	}
	...
	public BoolPointer _stableEA() throws CorruptDataException {
		return BoolPointer.cast(nonNullFieldEA(MM_RememberedSetCardList.__stableOffset_));
	}
