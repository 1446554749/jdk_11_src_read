...
/**
 * Structure: J9IndexableObjectDiscontiguousPointer
 *
 ...
 *
 * The generated code will provide getters for all elements in the J9IndexableObjectDiscontiguousPointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=J9IndexableObjectDiscontiguous.class)
...
/*[END USER CODE]*/
	...
	protected J9IndexableObjectDiscontiguousPointer(long address) {
		super(address);
	}

	public static J9IndexableObjectDiscontiguousPointer cast(AbstractPointer structure) {
	...
	public static J9IndexableObjectDiscontiguousPointer cast(long address) {
		if (address == 0) {
			return NULL;
		}
		return new J9IndexableObjectDiscontiguousPointer(address);
	}

	public J9IndexableObjectDiscontiguousPointer add(long count) {
		return J9IndexableObjectDiscontiguousPointer.cast(address + (J9IndexableObjectDiscontiguous.SIZEOF * count));
	}

	public J9IndexableObjectDiscontiguousPointer add(Scalar count) {
		return add(count.longValue());
	}

	public J9IndexableObjectDiscontiguousPointer addOffset(long offset) {
		return J9IndexableObjectDiscontiguousPointer.cast(address + offset);
	}

	public J9IndexableObjectDiscontiguousPointer addOffset(Scalar offset) {
		return addOffset(offset.longValue());
	}

	public J9IndexableObjectDiscontiguousPointer sub(long count) {
		return J9IndexableObjectDiscontiguousPointer.cast(address - (J9IndexableObjectDiscontiguous.SIZEOF * count));
	}

	public J9IndexableObjectDiscontiguousPointer sub(Scalar count) {
		return sub(count.longValue());
	}

	public J9IndexableObjectDiscontiguousPointer subOffset(long offset) {
		return J9IndexableObjectDiscontiguousPointer.cast(address - offset);
	}

	public J9IndexableObjectDiscontiguousPointer subOffset(Scalar offset) {
		return subOffset(offset.longValue());
	}

	public J9IndexableObjectDiscontiguousPointer untag(long mask) {
		return J9IndexableObjectDiscontiguousPointer.cast(address & ~mask);
	}
	...
	public VoidPointer dataAddr() throws CorruptDataException {
		return VoidPointer.cast(getPointerAtOffset(J9IndexableObjectDiscontiguous._dataAddrOffset_));
	}

	// void* dataAddr
	public PointerPointer dataAddrEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9IndexableObjectDiscontiguous._dataAddrOffset_));
	}
	...
	public UDATAPointer mustBeZeroEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(J9IndexableObjectDiscontiguous._mustBeZeroOffset_));
	}
	...
	public UDATAPointer paddingEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(J9IndexableObjectDiscontiguous._paddingOffset_));
	}
	...
	public UDATAPointer sizeEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(J9IndexableObjectDiscontiguous._sizeOffset_));
	}
