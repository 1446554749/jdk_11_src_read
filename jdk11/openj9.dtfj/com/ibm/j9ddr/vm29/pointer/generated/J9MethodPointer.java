 ...
 *
 * The generated code will provide getters for all elements in the J9MethodPointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=J9Method.class)
public class J9MethodPointer extends StructurePointer {

	// NULL
	public static final J9MethodPointer NULL = new J9MethodPointer(0);
...
/*[END USER CODE]*/
	...
	public J9MethodPointer add(long count) {
		return J9MethodPointer.cast(address + (J9Method.SIZEOF * count));
	}
	...
	public J9MethodPointer addOffset(long offset) {
		return J9MethodPointer.cast(address + offset);
	}
	...
	public J9MethodPointer untag(long mask) {
		return J9MethodPointer.cast(address & ~mask);
	}
	...
	// U8* bytecodes
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="_bytecodesOffset_", declaredType="U8*")
	public U8Pointer bytecodes() throws CorruptDataException {
		return U8Pointer.cast(getPointerAtOffset(J9Method._bytecodesOffset_));
	}

	// U8* bytecodes
	public PointerPointer bytecodesEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9Method._bytecodesOffset_));
	}
	...
	public J9ConstantPoolPointer constantPool() throws CorruptDataException {
		return J9ConstantPoolPointer.cast(getPointerAtOffset(J9Method._constantPoolOffset_));
	}

	// J9ConstantPool* constantPool
	public PointerPointer constantPoolEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9Method._constantPoolOffset_));
	}

	// volatile void* extra
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="_extraOffset_", declaredType="volatile void*")
	public VoidPointer extra() throws CorruptDataException {
		return VoidPointer.cast(getPointerAtOffset(J9Method._extraOffset_));
	}

	// volatile void* extra
	public PointerPointer extraEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9Method._extraOffset_));
	}

	// void* methodRunAddress
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="_methodRunAddressOffset_", declaredType="void*")
	public VoidPointer methodRunAddress() throws CorruptDataException {
		return VoidPointer.cast(getPointerAtOffset(J9Method._methodRunAddressOffset_));
	}

	// void* methodRunAddress
	public PointerPointer methodRunAddressEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9Method._methodRunAddressOffset_));
	}
