...
/**
 * Structure: J9ExceptionHandlerPointer
 *
 ...
 *
 * The generated code will provide getters for all elements in the J9ExceptionHandlerPointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=J9ExceptionHandler.class)
...
/*[END USER CODE]*/
	...
	protected J9ExceptionHandlerPointer(long address) {
		super(address);
	}

	public static J9ExceptionHandlerPointer cast(AbstractPointer structure) {
	...
	public static J9ExceptionHandlerPointer cast(long address) {
		if (address == 0) {
			return NULL;
		}
		return new J9ExceptionHandlerPointer(address);
	}

	public J9ExceptionHandlerPointer add(long count) {
		return J9ExceptionHandlerPointer.cast(address + (J9ExceptionHandler.SIZEOF * count));
	}

	public J9ExceptionHandlerPointer add(Scalar count) {
		return add(count.longValue());
	}

	public J9ExceptionHandlerPointer addOffset(long offset) {
		return J9ExceptionHandlerPointer.cast(address + offset);
	}

	public J9ExceptionHandlerPointer addOffset(Scalar offset) {
		return addOffset(offset.longValue());
	}

	public J9ExceptionHandlerPointer sub(long count) {
		return J9ExceptionHandlerPointer.cast(address - (J9ExceptionHandler.SIZEOF * count));
	}

	public J9ExceptionHandlerPointer sub(Scalar count) {
		return sub(count.longValue());
	}

	public J9ExceptionHandlerPointer subOffset(long offset) {
		return J9ExceptionHandlerPointer.cast(address - offset);
	}

	public J9ExceptionHandlerPointer subOffset(Scalar offset) {
		return subOffset(offset.longValue());
	}

	public J9ExceptionHandlerPointer untag(long mask) {
		return J9ExceptionHandlerPointer.cast(address & ~mask);
	}
	...
	// U32 exceptionClassIndex
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="_exceptionClassIndexOffset_", declaredType="U32")
