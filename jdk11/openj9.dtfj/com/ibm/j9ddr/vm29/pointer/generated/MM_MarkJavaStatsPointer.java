...
/**
 * Structure: MM_MarkJavaStatsPointer
 *
 ...
 *
 * The generated code will provide getters for all elements in the MM_MarkJavaStatsPointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=MM_MarkJavaStats.class)
...
/*[END USER CODE]*/
	...
	protected MM_MarkJavaStatsPointer(long address) {
		super(address);
	}

	public static MM_MarkJavaStatsPointer cast(AbstractPointer structure) {
	...
	public static MM_MarkJavaStatsPointer cast(long address) {
		if (address == 0) {
			return NULL;
		}
		return new MM_MarkJavaStatsPointer(address);
	}

	public MM_MarkJavaStatsPointer add(long count) {
		return MM_MarkJavaStatsPointer.cast(address + (MM_MarkJavaStats.SIZEOF * count));
	}

	public MM_MarkJavaStatsPointer add(Scalar count) {
		return add(count.longValue());
	}

	public MM_MarkJavaStatsPointer addOffset(long offset) {
		return MM_MarkJavaStatsPointer.cast(address + offset);
	}

	public MM_MarkJavaStatsPointer addOffset(Scalar offset) {
		return addOffset(offset.longValue());
	}

	public MM_MarkJavaStatsPointer sub(long count) {
		return MM_MarkJavaStatsPointer.cast(address - (MM_MarkJavaStats.SIZEOF * count));
	}

	public MM_MarkJavaStatsPointer sub(Scalar count) {
		return sub(count.longValue());
	}

	public MM_MarkJavaStatsPointer subOffset(long offset) {
		return MM_MarkJavaStatsPointer.cast(address - offset);
	}

	public MM_MarkJavaStatsPointer subOffset(Scalar offset) {
		return subOffset(offset.longValue());
	}

	public MM_MarkJavaStatsPointer untag(long mask) {
		return MM_MarkJavaStatsPointer.cast(address & ~mask);
	}
	...
	public UDATA _monitorReferenceCandidates() throws CorruptDataException {
		return getUDATAAtOffset(MM_MarkJavaStats.__monitorReferenceCandidatesOffset_);
	}

	// UDATA _monitorReferenceCandidates
	public UDATAPointer _monitorReferenceCandidatesEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_MarkJavaStats.__monitorReferenceCandidatesOffset_));
	}
	...
	public UDATA _monitorReferenceCleared() throws CorruptDataException {
		return getUDATAAtOffset(MM_MarkJavaStats.__monitorReferenceClearedOffset_);
	}

	// UDATA _monitorReferenceCleared
	public UDATAPointer _monitorReferenceClearedEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_MarkJavaStats.__monitorReferenceClearedOffset_));
	}
	...
	public UDATA _ownableSynchronizerCandidates() throws CorruptDataException {
		return getUDATAAtOffset(MM_MarkJavaStats.__ownableSynchronizerCandidatesOffset_);
	}

	// UDATA _ownableSynchronizerCandidates
	public UDATAPointer _ownableSynchronizerCandidatesEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_MarkJavaStats.__ownableSynchronizerCandidatesOffset_));
	}
	...
	public UDATA _ownableSynchronizerCleared() throws CorruptDataException {
		return getUDATAAtOffset(MM_MarkJavaStats.__ownableSynchronizerClearedOffset_);
	}

	// UDATA _ownableSynchronizerCleared
	public UDATAPointer _ownableSynchronizerClearedEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_MarkJavaStats.__ownableSynchronizerClearedOffset_));
	}
	...
	public MM_ReferenceStatsPointer _phantomReferenceStats() throws CorruptDataException {
		return MM_ReferenceStatsPointer.cast(nonNullFieldEA(MM_MarkJavaStats.__phantomReferenceStatsOffset_));
	}

	// MM_ReferenceStats _phantomReferenceStats
	public PointerPointer _phantomReferenceStatsEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(MM_MarkJavaStats.__phantomReferenceStatsOffset_));
	}
	...
	public MM_ReferenceStatsPointer _softReferenceStats() throws CorruptDataException {
		return MM_ReferenceStatsPointer.cast(nonNullFieldEA(MM_MarkJavaStats.__softReferenceStatsOffset_));
	}

	// MM_ReferenceStats _softReferenceStats
	public PointerPointer _softReferenceStatsEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(MM_MarkJavaStats.__softReferenceStatsOffset_));
	}
	...
	public UDATA _stringConstantsCandidates() throws CorruptDataException {
		return getUDATAAtOffset(MM_MarkJavaStats.__stringConstantsCandidatesOffset_);
	}

	// UDATA _stringConstantsCandidates
	public UDATAPointer _stringConstantsCandidatesEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_MarkJavaStats.__stringConstantsCandidatesOffset_));
	}
	...
	public UDATA _stringConstantsCleared() throws CorruptDataException {
		return getUDATAAtOffset(MM_MarkJavaStats.__stringConstantsClearedOffset_);
	}

	// UDATA _stringConstantsCleared
	public UDATAPointer _stringConstantsClearedEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_MarkJavaStats.__stringConstantsClearedOffset_));
	}
	...
	public UDATA _unfinalizedCandidates() throws CorruptDataException {
		return getUDATAAtOffset(MM_MarkJavaStats.__unfinalizedCandidatesOffset_);
	}

	// UDATA _unfinalizedCandidates
	public UDATAPointer _unfinalizedCandidatesEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_MarkJavaStats.__unfinalizedCandidatesOffset_));
	}
	...
	public UDATA _unfinalizedEnqueued() throws CorruptDataException {
		return getUDATAAtOffset(MM_MarkJavaStats.__unfinalizedEnqueuedOffset_);
	}

	// UDATA _unfinalizedEnqueued
	public UDATAPointer _unfinalizedEnqueuedEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_MarkJavaStats.__unfinalizedEnqueuedOffset_));
	}
	...
	public MM_ReferenceStatsPointer _weakReferenceStats() throws CorruptDataException {
		return MM_ReferenceStatsPointer.cast(nonNullFieldEA(MM_MarkJavaStats.__weakReferenceStatsOffset_));
	}

	// MM_ReferenceStats _weakReferenceStats
	public PointerPointer _weakReferenceStatsEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(MM_MarkJavaStats.__weakReferenceStatsOffset_));
	}

	// UDATA splitArraysAmount
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="_splitArraysAmountOffset_", declaredType="UDATA")
	public UDATA splitArraysAmount() throws CorruptDataException {
		return getUDATAAtOffset(MM_MarkJavaStats._splitArraysAmountOffset_);
	}

	// UDATA splitArraysAmount
	public UDATAPointer splitArraysAmountEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_MarkJavaStats._splitArraysAmountOffset_));
	}

	// UDATA splitArraysProcessed
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="_splitArraysProcessedOffset_", declaredType="UDATA")
	public UDATA splitArraysProcessed() throws CorruptDataException {
		return getUDATAAtOffset(MM_MarkJavaStats._splitArraysProcessedOffset_);
	}

	// UDATA splitArraysProcessed
	public UDATAPointer splitArraysProcessedEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_MarkJavaStats._splitArraysProcessedOffset_));
	}
