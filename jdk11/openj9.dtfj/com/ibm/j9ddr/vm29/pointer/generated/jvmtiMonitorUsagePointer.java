...
/*[END USER CODE]*/
	...
	public IDATAPointer entry_countEA() throws CorruptDataException {
		return IDATAPointer.cast(nonNullFieldEA(jvmtiMonitorUsage._entry_countOffset_));
	}
	...
	public IDATAPointer notify_waiter_countEA() throws CorruptDataException {
		return IDATAPointer.cast(nonNullFieldEA(jvmtiMonitorUsage._notify_waiter_countOffset_));
	}
	...
	public PointerPointer notify_waitersEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(jvmtiMonitorUsage._notify_waitersOffset_));
	}
	...
	public _jobjectPointer owner() throws CorruptDataException {
		return _jobjectPointer.cast(getPointerAtOffset(jvmtiMonitorUsage._ownerOffset_));
	}

	// jthread owner
	public PointerPointer ownerEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(jvmtiMonitorUsage._ownerOffset_));
	}
	...
	public IDATAPointer waiter_countEA() throws CorruptDataException {
		return IDATAPointer.cast(nonNullFieldEA(jvmtiMonitorUsage._waiter_countOffset_));
	}
	...
	public PointerPointer waitersEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(jvmtiMonitorUsage._waitersOffset_));
	}
