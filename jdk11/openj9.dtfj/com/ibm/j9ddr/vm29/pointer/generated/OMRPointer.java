 ...
 *
 * The generated code will provide getters for all elements in the OMRPointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=OMR.class)
public class OMRPointer extends StructurePointer {

	// NULL
	public static final OMRPointer NULL = new OMRPointer(0);
...
/*[END USER CODE]*/
	...
	public OMRPointer add(long count) {
		return OMRPointer.cast(address + (OMR.SIZEOF * count));
	}
	...
	public OMRPointer addOffset(long offset) {
		return OMRPointer.cast(address + offset);
	}
	...
	public OMRPointer untag(long mask) {
		return OMRPointer.cast(address & ~mask);
	}
