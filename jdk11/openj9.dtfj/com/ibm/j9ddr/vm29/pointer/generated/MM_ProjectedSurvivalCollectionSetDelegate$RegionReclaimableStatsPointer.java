...
/**
 * Structure: MM_ProjectedSurvivalCollectionSetDelegate$RegionReclaimableStatsPointer
 *
 ...
 *
 * The generated code will provide getters for all elements in the MM_ProjectedSurvivalCollectionSetDelegate$RegionReclaimableStatsPointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=MM_ProjectedSurvivalCollectionSetDelegate$RegionReclaimableStats.class)
...
/*[END USER CODE]*/
	...
	protected MM_ProjectedSurvivalCollectionSetDelegate$RegionReclaimableStatsPointer(long address) {
		super(address);
	}

	public static MM_ProjectedSurvivalCollectionSetDelegate$RegionReclaimableStatsPointer cast(AbstractPointer structure) {
	...
	public static MM_ProjectedSurvivalCollectionSetDelegate$RegionReclaimableStatsPointer cast(long address) {
		if (address == 0) {
			return NULL;
		}
		return new MM_ProjectedSurvivalCollectionSetDelegate$RegionReclaimableStatsPointer(address);
	}

	public MM_ProjectedSurvivalCollectionSetDelegate$RegionReclaimableStatsPointer add(long count) {
		return MM_ProjectedSurvivalCollectionSetDelegate$RegionReclaimableStatsPointer.cast(address + (MM_ProjectedSurvivalCollectionSetDelegate$RegionReclaimableStats.SIZEOF * count));
	}

	public MM_ProjectedSurvivalCollectionSetDelegate$RegionReclaimableStatsPointer add(Scalar count) {
		return add(count.longValue());
	}

	public MM_ProjectedSurvivalCollectionSetDelegate$RegionReclaimableStatsPointer addOffset(long offset) {
		return MM_ProjectedSurvivalCollectionSetDelegate$RegionReclaimableStatsPointer.cast(address + offset);
	}

	public MM_ProjectedSurvivalCollectionSetDelegate$RegionReclaimableStatsPointer addOffset(Scalar offset) {
		return addOffset(offset.longValue());
	}

	public MM_ProjectedSurvivalCollectionSetDelegate$RegionReclaimableStatsPointer sub(long count) {
		return MM_ProjectedSurvivalCollectionSetDelegate$RegionReclaimableStatsPointer.cast(address - (MM_ProjectedSurvivalCollectionSetDelegate$RegionReclaimableStats.SIZEOF * count));
	}

	public MM_ProjectedSurvivalCollectionSetDelegate$RegionReclaimableStatsPointer sub(Scalar count) {
		return sub(count.longValue());
	}

	public MM_ProjectedSurvivalCollectionSetDelegate$RegionReclaimableStatsPointer subOffset(long offset) {
		return MM_ProjectedSurvivalCollectionSetDelegate$RegionReclaimableStatsPointer.cast(address - offset);
	}

	public MM_ProjectedSurvivalCollectionSetDelegate$RegionReclaimableStatsPointer subOffset(Scalar offset) {
		return subOffset(offset.longValue());
	}

	public MM_ProjectedSurvivalCollectionSetDelegate$RegionReclaimableStatsPointer untag(long mask) {
		return MM_ProjectedSurvivalCollectionSetDelegate$RegionReclaimableStatsPointer.cast(address & ~mask);
	}
