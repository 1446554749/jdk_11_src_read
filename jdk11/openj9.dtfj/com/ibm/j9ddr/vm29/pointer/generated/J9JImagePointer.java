...
/*[END USER CODE]*/
	...
	public IDATA fd() throws CorruptDataException {
		return getIDATAAtOffset(J9JImage._fdOffset_);
	}

	// IDATA fd
	public IDATAPointer fdEA() throws CorruptDataException {
		return IDATAPointer.cast(nonNullFieldEA(J9JImage._fdOffset_));
	}
	...
	public UDATAPointer fileLengthEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(J9JImage._fileLengthOffset_));
	}
	...
	public PointerPointer fileNameEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9JImage._fileNameOffset_));
	}
	...
	public J9JImageHeaderPointer j9jimageHeader() throws CorruptDataException {
		return J9JImageHeaderPointer.cast(getPointerAtOffset(J9JImage._j9jimageHeaderOffset_));
	}

	// J9JImageHeader* j9jimageHeader
	public PointerPointer j9jimageHeaderEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9JImage._j9jimageHeaderOffset_));
	}
	...
	public J9MmapHandlePointer jimageMmap() throws CorruptDataException {
		return J9MmapHandlePointer.cast(getPointerAtOffset(J9JImage._jimageMmapOffset_));
	}

	// J9MmapHandle* jimageMmap
	public PointerPointer jimageMmapEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9JImage._jimageMmapOffset_));
	}
