...
/**
 * Structure: GC_ClassStaticsDeclarationOrderIteratorPointer
 *
 ...
 *
 * The generated code will provide getters for all elements in the GC_ClassStaticsDeclarationOrderIteratorPointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=GC_ClassStaticsDeclarationOrderIterator.class)
...
/*[END USER CODE]*/
	...
	protected GC_ClassStaticsDeclarationOrderIteratorPointer(long address) {
		super(address);
	}

	public static GC_ClassStaticsDeclarationOrderIteratorPointer cast(AbstractPointer structure) {
	...
	public static GC_ClassStaticsDeclarationOrderIteratorPointer cast(long address) {
		if (address == 0) {
			return NULL;
		}
		return new GC_ClassStaticsDeclarationOrderIteratorPointer(address);
	}

	public GC_ClassStaticsDeclarationOrderIteratorPointer add(long count) {
		return GC_ClassStaticsDeclarationOrderIteratorPointer.cast(address + (GC_ClassStaticsDeclarationOrderIterator.SIZEOF * count));
	}

	public GC_ClassStaticsDeclarationOrderIteratorPointer add(Scalar count) {
		return add(count.longValue());
	}

	public GC_ClassStaticsDeclarationOrderIteratorPointer addOffset(long offset) {
		return GC_ClassStaticsDeclarationOrderIteratorPointer.cast(address + offset);
	}

	public GC_ClassStaticsDeclarationOrderIteratorPointer addOffset(Scalar offset) {
		return addOffset(offset.longValue());
	}

	public GC_ClassStaticsDeclarationOrderIteratorPointer sub(long count) {
		return GC_ClassStaticsDeclarationOrderIteratorPointer.cast(address - (GC_ClassStaticsDeclarationOrderIterator.SIZEOF * count));
	}

	public GC_ClassStaticsDeclarationOrderIteratorPointer sub(Scalar count) {
		return sub(count.longValue());
	}

	public GC_ClassStaticsDeclarationOrderIteratorPointer subOffset(long offset) {
		return GC_ClassStaticsDeclarationOrderIteratorPointer.cast(address - offset);
	}

	public GC_ClassStaticsDeclarationOrderIteratorPointer subOffset(Scalar offset) {
		return subOffset(offset.longValue());
	}

	public GC_ClassStaticsDeclarationOrderIteratorPointer untag(long mask) {
		return GC_ClassStaticsDeclarationOrderIteratorPointer.cast(address & ~mask);
	}
