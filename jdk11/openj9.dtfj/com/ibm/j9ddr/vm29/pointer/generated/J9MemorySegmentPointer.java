...
/*[END USER CODE]*/
	...
	public PointerPointer baseAddressEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9MemorySegment._baseAddressOffset_));
	}
	...
	public PointerPointer classLoaderEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9MemorySegment._classLoaderOffset_));
	}
	...
	public PointerPointer heapAllocEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9MemorySegment._heapAllocOffset_));
	}
	...
	public PointerPointer heapBaseEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9MemorySegment._heapBaseOffset_));
	}
	...
	public PointerPointer heapTopEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9MemorySegment._heapTopOffset_));
	}
	...
	public PointerPointer memorySegmentListEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9MemorySegment._memorySegmentListOffset_));
	}
	...
	public PointerPointer memorySpaceEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9MemorySegment._memorySpaceOffset_));
	}
	...
	public J9MemorySegmentPointer nextSegment() throws CorruptDataException {
		return J9MemorySegmentPointer.cast(getPointerAtOffset(J9MemorySegment._nextSegmentOffset_));
	}

	// J9MemorySegment* nextSegment
	public PointerPointer nextSegmentEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9MemorySegment._nextSegmentOffset_));
	}
	...
	public J9MemorySegmentPointer nextSegmentInClassLoader() throws CorruptDataException {
		return J9MemorySegmentPointer.cast(getPointerAtOffset(J9MemorySegment._nextSegmentInClassLoaderOffset_));
	}

	// J9MemorySegment* nextSegmentInClassLoader
	public PointerPointer nextSegmentInClassLoaderEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9MemorySegment._nextSegmentInClassLoaderOffset_));
	}
	...
	public J9AVLTreeNodePointer parentAVLTreeNode() throws CorruptDataException {
		return J9AVLTreeNodePointer.cast(nonNullFieldEA(J9MemorySegment._parentAVLTreeNodeOffset_));
	}

	// J9AVLTreeNode parentAVLTreeNode
	public PointerPointer parentAVLTreeNodeEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9MemorySegment._parentAVLTreeNodeOffset_));
	}
	...
	public J9MemorySegmentPointer previousSegment() throws CorruptDataException {
		return J9MemorySegmentPointer.cast(getPointerAtOffset(J9MemorySegment._previousSegmentOffset_));
	}

	// J9MemorySegment* previousSegment
	public PointerPointer previousSegmentEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9MemorySegment._previousSegmentOffset_));
	}
	...
	public UDATAPointer sizeEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(J9MemorySegment._sizeOffset_));
	}
	...
	public UDATAPointer typeEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(J9MemorySegment._typeOffset_));
	}
	...
	public UDATAPointer unused1EA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(J9MemorySegment._unused1Offset_));
	}
	...
	public J9PortVmemIdentifierPointer vmemIdentifier() throws CorruptDataException {
		return J9PortVmemIdentifierPointer.cast(nonNullFieldEA(J9MemorySegment._vmemIdentifierOffset_));
	}

	// J9PortVmemIdentifier vmemIdentifier
	public PointerPointer vmemIdentifierEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9MemorySegment._vmemIdentifierOffset_));
	}
