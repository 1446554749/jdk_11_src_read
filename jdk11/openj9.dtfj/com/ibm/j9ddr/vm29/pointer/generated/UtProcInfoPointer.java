...
/*[END USER CODE]*/
	...
	public UtDataHeaderPointer header() throws CorruptDataException {
		return UtDataHeaderPointer.cast(nonNullFieldEA(UtProcInfo._headerOffset_));
	}

	// UtDataHeader header
	public PointerPointer headerEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(UtProcInfo._headerOffset_));
	}
	...
	public EnumPointer subtypeEA() throws CorruptDataException {
		return EnumPointer.cast(nonNullFieldEA(UtProcInfo._subtypeOffset_), UtSubtype.class);
	}
	...
	public EnumPointer traceCounterEA() throws CorruptDataException {
		return EnumPointer.cast(nonNullFieldEA(UtProcInfo._traceCounterOffset_), UtTraceCounter.class);
	}
