...
/*[END USER CODE]*/
	...
	public UDATA argCount() throws CorruptDataException {
		return getUDATAAtOffset(J9SWFrame._argCountOffset_);
	}

	// UDATA argCount
	public UDATAPointer argCountEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(J9SWFrame._argCountOffset_));
	}
	...
	public PointerPointer bottomSlotEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9SWFrame._bottomSlotOffset_));
	}
	...
	public PointerPointer cpEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9SWFrame._cpOffset_));
	}
	...
	public UDATA frameFlags() throws CorruptDataException {
		return getUDATAAtOffset(J9SWFrame._frameFlagsOffset_);
	}

	// UDATA frameFlags
	public UDATAPointer frameFlagsEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(J9SWFrame._frameFlagsOffset_));
	}
	...
	public J9SWFrameTypeDescriptorPointer ftd() throws CorruptDataException {
		return J9SWFrameTypeDescriptorPointer.cast(nonNullFieldEA(J9SWFrame._ftdOffset_));
	}

	// J9SWFrameTypeDescriptor ftd
	public PointerPointer ftdEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9SWFrame._ftdOffset_));
	}
	...
	public J9SWFramePointer linkNext() throws CorruptDataException {
		return J9SWFramePointer.cast(getPointerAtOffset(J9SWFrame._linkNextOffset_));
	}

	// J9SWFrame* linkNext
	public PointerPointer linkNextEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9SWFrame._linkNextOffset_));
	}
	...
	public J9SWFramePointer linkPrevious() throws CorruptDataException {
		return J9SWFramePointer.cast(getPointerAtOffset(J9SWFrame._linkPreviousOffset_));
	}

	// J9SWFrame* linkPrevious
	public PointerPointer linkPreviousEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9SWFrame._linkPreviousOffset_));
	}
	...
	public UDATA literals() throws CorruptDataException {
		return getUDATAAtOffset(J9SWFrame._literalsOffset_);
	}

	// UDATA literals
	public UDATAPointer literalsEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(J9SWFrame._literalsOffset_));
	}
	...
	public J9MethodPointer method() throws CorruptDataException {
		return J9MethodPointer.cast(getPointerAtOffset(J9SWFrame._methodOffset_));
	}

	// J9Method* method
	public PointerPointer methodEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9SWFrame._methodOffset_));
	}
	...
	public PointerPointer nameEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9SWFrame._nameOffset_));
	}
	...
	public UDATA number() throws CorruptDataException {
		return getUDATAAtOffset(J9SWFrame._numberOffset_);
	}

	// UDATA number
	public UDATAPointer numberEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(J9SWFrame._numberOffset_));
	}
	...
	public PointerPointer pcEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9SWFrame._pcOffset_));
	}
	...
	public PointerPointer topSlotEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9SWFrame._topSlotOffset_));
	}
	...
	public UDATA type() throws CorruptDataException {
		return getUDATAAtOffset(J9SWFrame._typeOffset_);
	}

	// UDATA type
	public UDATAPointer typeEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(J9SWFrame._typeOffset_));
	}
