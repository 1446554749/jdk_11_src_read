...
/*[END USER CODE]*/
	...
	public UDATAPointer _bitIndexHeadEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_HeapMapIterator.__bitIndexHeadOffset_));
	}
	...
	public MM_GCExtensionsBasePointer _extensions() throws CorruptDataException {
		return MM_GCExtensionsBasePointer.cast(getPointerAtOffset(MM_HeapMapIterator.__extensionsOffset_));
	}

	// const MM_GCExtensionsBase* _extensions
	public PointerPointer _extensionsEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(MM_HeapMapIterator.__extensionsOffset_));
	}
	...
	public PointerPointer _heapChunkTopEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(MM_HeapMapIterator.__heapChunkTopOffset_));
	}
	...
	public PointerPointer _heapMapSlotCurrentEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(MM_HeapMapIterator.__heapMapSlotCurrentOffset_));
	}
	...
	public UDATAPointer _heapMapSlotValueEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(MM_HeapMapIterator.__heapMapSlotValueOffset_));
	}
	...
	public PointerPointer _heapSlotCurrentEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(MM_HeapMapIterator.__heapSlotCurrentOffset_));
	}
	...
	public BoolPointer _useLargeObjectOptimizationEA() throws CorruptDataException {
		return BoolPointer.cast(nonNullFieldEA(MM_HeapMapIterator.__useLargeObjectOptimizationOffset_));
	}
