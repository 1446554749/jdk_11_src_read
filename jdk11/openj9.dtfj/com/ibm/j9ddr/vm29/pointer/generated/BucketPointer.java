 ...
 *
 * The generated code will provide getters for all elements in the BucketPointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=Bucket.class)
public class BucketPointer extends StructurePointer {

	// NULL
	public static final BucketPointer NULL = new BucketPointer(0);
...
/*[END USER CODE]*/
	...
	public BucketPointer add(long count) {
		return BucketPointer.cast(address + (Bucket.SIZEOF * count));
	}
	...
	public BucketPointer addOffset(long offset) {
		return BucketPointer.cast(address + offset);
	}
	...
	public BucketPointer untag(long mask) {
		return BucketPointer.cast(address & ~mask);
	}
	...
	// UDATA cardCount
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="_cardCountOffset_", declaredType="UDATA")
	public UDATA cardCount() throws CorruptDataException {
		return getUDATAAtOffset(Bucket._cardCountOffset_);
	}

	// UDATA cardCount
	public UDATAPointer cardCountEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(Bucket._cardCountOffset_));
	}

	// UDATA duplicates
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="_duplicatesOffset_", declaredType="UDATA")
	public UDATA duplicates() throws CorruptDataException {
		return getUDATAAtOffset(Bucket._duplicatesOffset_);
	}

	// UDATA duplicates
	public UDATAPointer duplicatesEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(Bucket._duplicatesOffset_));
	}
	...
	public UDATA regionCount() throws CorruptDataException {
		return getUDATAAtOffset(Bucket._regionCountOffset_);
	}

	// UDATA regionCount
	public UDATAPointer regionCountEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(Bucket._regionCountOffset_));
	}
