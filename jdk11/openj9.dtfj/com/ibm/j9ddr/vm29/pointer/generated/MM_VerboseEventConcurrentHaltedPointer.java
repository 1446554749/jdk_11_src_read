...
/**
 * Structure: MM_VerboseEventConcurrentHaltedPointer
 *
 ...
 *
 * The generated code will provide getters for all elements in the MM_VerboseEventConcurrentHaltedPointer
 * structure.  Where possible, meaningful return types are inferred.
 *
 * The user may add methods to provide meaningful return types where only pointers
 * could be automatically inferred.
 */
@com.ibm.j9ddr.GeneratedPointerClass(structureClass=MM_VerboseEventConcurrentHalted.class)
...
/*[END USER CODE]*/
	...
	protected MM_VerboseEventConcurrentHaltedPointer(long address) {
		super(address);
	}

	public static MM_VerboseEventConcurrentHaltedPointer cast(AbstractPointer structure) {
	...
	public static MM_VerboseEventConcurrentHaltedPointer cast(long address) {
		if (address == 0) {
			return NULL;
		}
		return new MM_VerboseEventConcurrentHaltedPointer(address);
	}

	public MM_VerboseEventConcurrentHaltedPointer add(long count) {
		return MM_VerboseEventConcurrentHaltedPointer.cast(address + (MM_VerboseEventConcurrentHalted.SIZEOF * count));
	}

	public MM_VerboseEventConcurrentHaltedPointer add(Scalar count) {
		return add(count.longValue());
	}

	public MM_VerboseEventConcurrentHaltedPointer addOffset(long offset) {
		return MM_VerboseEventConcurrentHaltedPointer.cast(address + offset);
	}

	public MM_VerboseEventConcurrentHaltedPointer addOffset(Scalar offset) {
		return addOffset(offset.longValue());
	}

	public MM_VerboseEventConcurrentHaltedPointer sub(long count) {
		return MM_VerboseEventConcurrentHaltedPointer.cast(address - (MM_VerboseEventConcurrentHalted.SIZEOF * count));
	}

	public MM_VerboseEventConcurrentHaltedPointer sub(Scalar count) {
		return sub(count.longValue());
	}

	public MM_VerboseEventConcurrentHaltedPointer subOffset(long offset) {
		return MM_VerboseEventConcurrentHaltedPointer.cast(address - offset);
	}

	public MM_VerboseEventConcurrentHaltedPointer subOffset(Scalar offset) {
		return subOffset(offset.longValue());
	}

	public MM_VerboseEventConcurrentHaltedPointer untag(long mask) {
		return MM_VerboseEventConcurrentHaltedPointer.cast(address & ~mask);
	}
	...
	// UDATA _cardCleaningThreshold
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="__cardCleaningThresholdOffset_", declaredType="UDATA")
	...
	// UDATA _executionMode
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="__executionModeOffset_", declaredType="UDATA")
	...
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="__isCardCleaningCompleteOffset_", declaredType="UDATA")
	...
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="__isTracingExhaustedOffset_", declaredType="UDATA")
	...
	@com.ibm.j9ddr.GeneratedFieldAccessor(offsetFieldName="__scanClassesModeOffset_", declaredType="UDATA")
