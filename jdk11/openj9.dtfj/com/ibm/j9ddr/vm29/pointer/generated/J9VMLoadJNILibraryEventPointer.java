...
/*[END USER CODE]*/
	...
	public UDATA bufLen() throws CorruptDataException {
		return getUDATAAtOffset(J9VMLoadJNILibraryEvent._bufLenOffset_);
	}

	// UDATA bufLen
	public UDATAPointer bufLenEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(J9VMLoadJNILibraryEvent._bufLenOffset_));
	}
	...
	public J9ClassLoaderPointer classLoader() throws CorruptDataException {
		return J9ClassLoaderPointer.cast(getPointerAtOffset(J9VMLoadJNILibraryEvent._classLoaderOffset_));
	}

	// J9ClassLoader* classLoader
	public PointerPointer classLoaderEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9VMLoadJNILibraryEvent._classLoaderOffset_));
	}
	...
	public J9VMThreadPointer currentThread() throws CorruptDataException {
		return J9VMThreadPointer.cast(getPointerAtOffset(J9VMLoadJNILibraryEvent._currentThreadOffset_));
	}

	// J9VMThread* currentThread
	public PointerPointer currentThreadEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9VMLoadJNILibraryEvent._currentThreadOffset_));
	}
	...
	public PointerPointer errorBufEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9VMLoadJNILibraryEvent._errorBufOffset_));
	}
	...
	public PointerPointer logicalNameEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9VMLoadJNILibraryEvent._logicalNameOffset_));
	}
	...
	public J9NativeLibraryPointer nativeLibrary() throws CorruptDataException {
		return J9NativeLibraryPointer.cast(getPointerAtOffset(J9VMLoadJNILibraryEvent._nativeLibraryOffset_));
	}

	// J9NativeLibrary* nativeLibrary
	public PointerPointer nativeLibraryEA() throws CorruptDataException {
		return PointerPointer.cast(nonNullFieldEA(J9VMLoadJNILibraryEvent._nativeLibraryOffset_));
	}
	...
	public UDATA openFlags() throws CorruptDataException {
		return getUDATAAtOffset(J9VMLoadJNILibraryEvent._openFlagsOffset_);
	}

	// UDATA openFlags
	public UDATAPointer openFlagsEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(J9VMLoadJNILibraryEvent._openFlagsOffset_));
	}
	...
	public UDATA result() throws CorruptDataException {
		return getUDATAAtOffset(J9VMLoadJNILibraryEvent._resultOffset_);
	}

	// UDATA result
	public UDATAPointer resultEA() throws CorruptDataException {
		return UDATAPointer.cast(nonNullFieldEA(J9VMLoadJNILibraryEvent._resultOffset_));
	}
